...
class HomePageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['mahalliy_xabarlar'] = News.published.all().filter(category__name="Mahalliy").order_by("-publish_time")[
                                       :5]
...
def contactPageView(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return HttpResponse("<H2> Sezga rahmat </H2>")
    context = {
        "form": form
    }
...
class NewsCreateView(OnlyLoggedSuperUser, CreateView):
    ...
    fields = ('title', 'title_uz', 'title_ru', 'title_en', 'slug', 'body', 'body_uz', 'body_ru', 'body_en',
