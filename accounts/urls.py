...
from .views import user_login, dashboard_view, user_register, SingnUpView, edit_user, EditUserView
...
urlpatterns = [
    ...
    path('password-chang-done/', PasswordChangeDoneView.as_view(), name='password_change_done'),
    ...
    # path('signup/', SingnUpView.as_view(), name='user_register'),
